...
public class StarterTests  {
	...
	public void testGiveSalary()
	{
		...
		localPersonList.giveRaises();
		System.out.println(localPersonList.people[0].getSalary());
		assertTrue(localPersonList.people[0].getSalary() == 11000);
		assertTrue(localPersonList.people[1].getSalary() == 6000);
		assertTrue(localPersonList.people[2].getSalary() == 11000);
	}
