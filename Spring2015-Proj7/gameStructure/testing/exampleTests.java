...
public class exampleTests {
	...
	public void testTwo() {
		...
		assertEquals(
				"BattleFish<Name: four  Strength: 14>",
				bq.fight().toString()
		);

		assertEquals(
				"BattleFish<Name: two  Strength: 11>",
				bq.fight().toString()
		);
	}
	...
	public void testThree() {
		...
		assertEquals(
				"BattleFish<Name: two  Strength: 12>",
				bq.fight().toString()
		);
		
		assertEquals(
				"BattleFish<Name: four  Strength: 13>",
				bq.fight().toString()
		);
	...
	public void testFour() {
		...
		assertEquals(
				"BattleFish<Name: two  Strength: 2>",
				bq.fight().toString()
		);


		assertEquals(
				"Contents: [ BattleFish<Name: three  Strength: 2>, BattleFish<Name: two  Strength: 1> ]",
				bq.toString()
		);
		
		assertEquals(
				"BattleFish<Name: three  Strength: 2>",
				bq.fight().toString()
		);
	...
	public void testFive() {
		...
		assertEquals(
				"BattleCow<Name: three  Strength: 13>",
				bq.fight().toString()
		);
		
		assertEquals(
				"BattleCow<Name: one  Strength: 10>",
				bq.fight().toString()
		);
	}
	...
	public void testSix() {
		...
		assertEquals(
				"PokeeCreature<Name: L  Strength: 7>",
				bq.fight().toString()
		);
		
		assertEquals(
				"BattleCow<Name: three  Strength: 12>",
				bq.fight().toString()
		);	
		
		assertEquals(
				"PokeeCreature<Name: A  Strength: 5>",
				bq.fight().toString()
		);
	...
	public void testSeven() {
		...
		assertEquals(
				"[PokeeCreature<Name: Z  Strength: 7>]",
				Arrays.toString(bq.export2D()[0])
		);
		assertEquals(
				"[BattleFish<Name: four  Strength: 14>, BattleFish<Name: two  Strength: 12>]",
				Arrays.toString(bq.export2D()[1])
		);
		assertEquals(
				"[]",
				Arrays.toString(bq.export2D()[2])
		);	
		assertEquals(
				"[]",
				Arrays.toString(bq.export2D()[3])
		);	
		assertEquals(
				"[]",
				Arrays.toString(bq.export2D()[4])
		);	
		assertEquals(
		...
		assertEquals(
				"[PokeeCreature<Name: L  Strength: 7>]",
				Arrays.toString(bq.export2D()[6])
		);	
		assertEquals(
				"[]",
				Arrays.toString(bq.export2D()[8])
		);	
		assertEquals(
				"[]",
				Arrays.toString(bq.export2D()[9])
		);	
	}
