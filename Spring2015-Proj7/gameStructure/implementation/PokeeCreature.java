...
public class PokeeCreature implements Battleable {
	 ...
	 * 
	 * @param nameIn desired name for this PokeeCreature
	 * @param strengthIn starting strength for this PokeeCreature
	 */
	...
	/**
	 * Getter for skill level of the PokeeCreature, which is calculated
	 * based on the first character of the name of the PokeeCreature.
	 * 
	 ...
	 * @param newStrength the new strength value for the PokeeCreature
	 */
